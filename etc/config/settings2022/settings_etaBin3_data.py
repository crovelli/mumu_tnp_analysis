...
tnpParNomFitJPsi = [
#    "meanP[3.08, 3.07, 3.10]","sigmaP[0.04, 0.02, 0.1]", "alphaLP[0.6, 0.05, 5.]","alphaRP[1.2, 0.1, 3.]","nLP[3.6, .01, 100.]","nRP[1.85, .010, 200.]",  # fino a 11 compreso
#    "meanF[3.09, 3.07, 3.11]","sigmaF[0.04, 0.02, 0.1]","alphaLF[1., 0.5, 3.]","alphaRF[1.2, 0.5, 5.0]","nLF[1., .1, 10.]","nRF[10., .1, 25.]",           # fino a 11 compreso   
#    "meanP[3.09, 3.07, 3.10]","sigmaP[0.04, 0.02, 0.1]", "alphaLP[0.6, 0.05, 5.]","alphaRP[1.2, 0.1, 3.]","nLP[3.6, .01, 100.]","nRP[1.85, .010, 200.]",  # fino a 32 compreso
#    "meanF[3.09, 3.07, 3.11]","sigmaF[0.045, 0.03, 0.1]","alphaLF[1., 0.5, 3.]","alphaRF[1.2, 0.5, 5.0]","nLF[1., .1, 10.]","nRF[10., .1, 25.]",          # fino a 32 compreso
    "meanP[3.09, 3.07, 3.11]","sigmaP[0.04, 0.02, 0.1]", "alphaLP[0.6, 0.05, 5.]","alphaRP[1.2, 0.1, 3.]","nLP[3.6, .01, 100.]","nRP[1.85, .010, 200.]",  
    "meanF[3.09, 3.07, 3.11]","sigmaF[0.045, 0.03, 0.1]","alphaLF[1., 0.5, 3.]","alphaRF[1.2, 0.5, 5.0]","nLF[1., .5, 10.]","nRF[10., .1, 25.]",
#    "expalphaP[0., -15., 1.]",       # fino a 29 compreso 
#    "expalphaF[0., -10., 1.]",       # fino a 26 compreso
#    "expalphaF[0., -10., 10.]",      # fino a 32 compreso  
    "expalphaP[0., -30., 1.]",        # da 30
    "expalphaF[0., -10., 20.]",       # da 33  
    ]
